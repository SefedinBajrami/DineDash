  ...
  return (
    <div className='contact' id='contact'>
      <div className="contact-col">
        ...
        <ul>
            <li><img src={assets.mail_icon} alt="" />sb30683@seeu.edu.mk</li>
            <li><img src={assets.mail_icon} alt="" />nm30732@seeu.edu.mk</li>
            <li><img src={assets.phone_icon} alt="" />+389-78-475-557</li>
            <li><img src={assets.location_icon} alt="" />SEEU SKOPJE</li>
        </ul>
      </div>
      <div className="contact-col">
